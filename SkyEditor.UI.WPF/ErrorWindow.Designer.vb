...
Partial Class ErrorWindow
    ...
    Private Sub InitializeComponent()
        ...
        Me.MinimumSize = New System.Drawing.Size(515, 275)
        Me.Name = "ErrorWindow"
        Me.Text = "ErrorWindow"
    ...
    Private WithEvents B_Continue As Windows.Forms.Button
    Private WithEvents B_Abort As Windows.Forms.Button
    Private WithEvents B_CopyToClipboard As Windows.Forms.Button
    Private WithEvents L_ProvideInfo As Windows.Forms.Label
    Private WithEvents L_Message As Windows.Forms.Label
    Private WithEvents T_ExceptionDetails As Windows.Forms.TextBox
End Class
